...
public class PlaylistController {
	...
	@PostMapping
	public ResponseEntity<Playlist> createPlaylist(@RequestBody @Valid PlaylistPostDTO playlistDTO) {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<PlaylistGetDTO> putPlaylist(@PathVariable Long id, @RequestBody PlaylistPostDTO playlistPutDTO) {
	    Playlist updatedPlaylist = playlistService.updatePlaylist(id, playlistPutDTO);
